...
const addEditTable = <HTMLTableElement>document.getElementById("addEditTable");
const txtWorkerName = <HTMLInputElement>document.getElementById("txtWorkerName");
const txtWorkerLastName = <HTMLInputElement>document.getElementById("txtWorkerLastName");
const txtWorkerBirthDay = <HTMLInputElement>document.getElementById("txtWorkerBirthDay");
const txtWorkerQual = <HTMLInputElement>document.getElementById("txtWorkerQual");

const btnLogout = <HTMLInputElement>document.getElementById("btnLogout");

const txtEmpName = <HTMLInputElement>document.getElementById("txtEmpName");
const txtLocation = <HTMLInputElement>document.getElementById("txtLocation");
const txtStartDate = <HTMLInputElement>document.getElementById("txtStartDate");
const txtEndDate = <HTMLInputElement>document.getElementById("txtEndDate");

const divSuc = document.getElementById("alertSuc");
...
function editEmployerRecord(e) {
    ...
    imgEmpOk.addEventListener('click', e =>{
...
imgEmpAdd.addEventListener('click', e => {
	if(txtEmpName.value == "" || txtLocation.value ==  "" ||
	   txtStartDate.value == "" || txtEndDate.value == ""){
		alert("All fields must be filled!");
		return;
